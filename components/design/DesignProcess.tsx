  ...
  return (
    <section className="py-12 md:py-16 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-[#2861AD] mb-10">
          {t('title')}
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {steps.map((step, idx) => (
            <div key={step.key} className="relative">
              <div className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:shadow-xl hover:border-[#2861AD]/30 transition-all duration-300 h-full">
                ...
                <p className="text-[#2861AD]/70 text-sm leading-relaxed">
